...
{
    [Table(TableFieldNameHelper.QLHSC07.AdministrativeFormalities, Schema = Constant.Schema.QLHSC07)]
    public class AdministrativeFormalities : BaseFullAuditedEntity<long>
    {
        public AdministrativeFormalities()
        {
