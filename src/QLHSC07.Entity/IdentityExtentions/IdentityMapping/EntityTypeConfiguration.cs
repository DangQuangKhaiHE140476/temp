...
namespace QLHSC07.Entity.IdentityExtentions.IdentityMapping
{
    ...
    public partial class QLHSC07EntityTypeConfiguration<TEntity> : IMappingConfiguration,
        IEntityTypeConfiguration<TEntity> where TEntity : BaseFullAuditedEntity<int>
    {
        #region Utilities
