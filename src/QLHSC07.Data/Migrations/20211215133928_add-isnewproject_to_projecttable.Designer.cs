...
namespace QLHSC07.Data.Migrations
{
    ...
    [Migration("20211215133928_add-isnewproject_to_projecttable")]
    partial class addisnewproject_to_projecttable
    {
            ...
            modelBuilder.Entity("QLHSC07.Entity.IdentityAccess.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "ADMIN",
                            ConcurrencyStamp = "bda43cbe-d3a3-409c-a6c0-129d79eb9d75",
                            Name = "ADMIN"
                        });
                });
            ...
            modelBuilder.Entity("QLHSC07.Entity.IdentityAccess.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "Hà Nội",
                            ConcurrencyStamp = "a38134ef-3ddd-4aa3-88b0-652b02a7532d",
