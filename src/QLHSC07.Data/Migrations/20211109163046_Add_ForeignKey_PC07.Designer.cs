...
namespace QLHSC07.Data.Migrations
{
    ...
    [Migration("20211109163046_Add_ForeignKey_PC07")]
    partial class Add_ForeignKey_PC07
    {
            ...
            modelBuilder.Entity("QLHSC07.Entity.IdentityAccess.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "ADMIN",
                            ConcurrencyStamp = "0d530c6d-6aad-4661-a4f1-661661acafaa",
                            Name = "ADMIN"
                        });
                });
            ...
            modelBuilder.Entity("QLHSC07.Entity.IdentityAccess.User", b =>
                {
                    ...
                    b.Property<long?>("pc07_local_id")
                        .HasColumnName("pc07_local_id1")
                        .HasColumnType("bigint");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "Hà Nội",
                            ConcurrencyStamp = "d1a56262-94a5-4f9b-8add-27179911a0a5",
            ...
            modelBuilder.Entity("QLHSC07.Entity.QLHSC07_Entities.Project", b =>
                {
                    ...
                    b.Property<long>("ConstructionTypeId")
                        .HasColumnName("construction_type_id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("QLHSC07.Entity.QLHSC07_Entities.Records", b =>
                {
                    ...
                    b.Property<long?>("records_types_id")
                        .HasColumnName("records_types_id1")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("QLHSC07.Entity.QLHSC07_Entities.RecordsType", b =>
                {
                    ...
                    b.Property<DateTime?>("MaximumProcessingDays")
                        .HasColumnName("maximum_processing_days")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("QLHSC07.Entity.QLHSC07_MSG_Entities.Message", b =>
                {
                    ...
                    b.Property<ICollection<long>>("FileAttachIds")
                        .HasColumnName("file_attach_ids")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("QLHSC07.Entity.QLHSC07_Entities.Project", b =>
                {
                    ...
                    b.HasOne("QLHSC07.Entity.QLHSC07_Entities.ConstructionType", "ConstructionTypes")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("QLHSC07.Entity.QLHSC07_Entities.Records", b =>
                {
                    ...
                    b.HasOne("QLHSC07.Entity.IdentityAccess.User", "ReceiveUser")
                        .WithMany()
                    ...
                    b.HasOne("QLHSC07.Entity.QLHSC07_Entities.RecordsType", "RecordsTypes")
                        .WithMany("Recordses")
                        .HasForeignKey("records_types_id");
                });
